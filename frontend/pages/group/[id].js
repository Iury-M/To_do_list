        ...
        {showNewTaskForm && (
          <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-8">
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              <div><input type="text" placeholder="Título da tarefa" className="w-full px-4 py-2 border rounded-md bg-white text-gray-900" value={title} onChange={(e) => setTitle(e.target.value)} required /> // Adicione bg-white text-gray-900</div>
              <div><textarea placeholder="Descrição" className="w-full px-4 py-2 border rounded-md bg-white text-gray-900" value={description} onChange={(e) => setDescription(e.target.value)} rows="3" /> // Adicione bg-white text-gray-900</div>
        ...
        {editingTask && (
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50"><div className="bg-white rounded-lg shadow-xl w-full max-w-2xl"><div className="p-6">
            ...
            <form onSubmit={(e) => { e.preventDefault(); handleEdit(editingTask.id); }} className="space-y-4">
              <div><input type="text" className="w-full px-4 py-2 border rounded-md bg-white text-gray-900" value={editTitle} onChange={(e) => setEditTitle(e.target.value)} required /> // Adicione bg-white text-gray-900</div>
              <div><textarea className="w-full px-4 py-2 border rounded-md bg-white text-gray-900" value={editDescription} onChange={(e) => setEditDescription(e.target.value)} rows="3"/> // Adicione bg-white text-gray-900</div>
